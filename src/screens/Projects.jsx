...
export default function Carusor({ images } = {}) {
  const defaultImages = [
    { href: 'https://currency-coverter-js.netlify.app/', src: Currency_converter },
    { href: 'https://kaleidoscopic-sherbet-c11a3d.netlify.app/', src: AI_chat },
    { href: 'https://js-quiz-web.netlify.app/', src: Quiz_APP }
  ]
